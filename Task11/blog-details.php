                ...
                <div class="row justify-content-center">
                    <div class="col-sm-6" style="padding-top: 5%;  text-align: center;">
                        <p class="fw-bold" style="font-size: xx-large ; color: dodgerblue; filter: brightness(100%); ">
                            Open Source
                            Job
                            Report Show More Openings Fewer </p>
                        <a class="text-light mt-4" href="index.php">Home / <a class="text-light" href="blog.html">Blog
                                / <a class="text-light" href="#">It Services /
                                </a> </a> </a>
                        <span style="color: steelblue; font-size: small;" class="fw-bold">Open Source Job
                            Report Show More Openings Fewer</span>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row justify-content-md-center">
                <div class="col-sm-9">
                                ...
                                <div class="row justify-content-md-center">
                                    <div class="col-sm-8">
                                        <span>
                                            ...
                                            it.
                                            But the load will be too heavy for us if we carry yesterday’s burden over
                                            again today,
                                            and then add the burden of the morrow before we are required to bear it.
                                        </span>
                                        <p>
                                            <hr style="color: navy; height: 2px; width: 8%; float: left; margin-right: 3%;">
                                            <span>Uğur.</span>
                                        </p>
                                    </div>
                                </div>
                    ...
                    <div class="row mt-4">
                        <div class="col-md-11">
                            <article>
                                <h3 class="fw-bold">Digital technology on the cutting edge</h3>
                                <ul class="mt-4" style="margin-left: 3%;">
                            ...
                            <img src="images/office.jpg" alt="post img"
                                class="pull-left img-responsive thumb margin10 img-thumbnail mt-4">
                            <h3>Open Source Job Report Show More Openings Fewer</h3>
                            <article>
                                <p class="mt-2">
                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem
                            ...
                            <div class="row justify-content-md-center">
                                <div class="col-sm-10">
                                    <div class="contact-form">
                                        <span class="fw-bold" style="font-size: x-large;">Leave a Reply</span>
