...
$query  = $db->query("SELECT * FROM posts where post_id=$intpostid",PDO::FETCH_ASSOC);
while($row = $query->fetch(PDO::FETCH_ASSOC))
{
   ...
   $postcommentcount= $row["post_comment_number"]; }
                ...
                <div class="col-sm-3">
                    ...
                    <div class="row" style=" background-color: ghostwhite; margin-top: 10%;">                        
                        ...
                        {                           
                           ...
                           $postcommentcount1= $row1["post_comment_number"];
                        ...
                        <div class="row">
                            ...
                            <div class="row g-0">
                                <p class="d-flex justify-content-center"> Author: <?php echo $postauthor1 ?> - Date: <?php echo $postdate1 ?></p>
                            </div>
                            <hr style="color: grey;">
                        </div>
                        <?php } ?>        
