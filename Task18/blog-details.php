...
<head>
    ...
    <meta name="description" content="<?php echo $post_seod ?>">
    <meta name="keywords" content="<?php echo $post_seok ?>">
    <title><?php echo $post_seot ?></title>
        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-sm-6" style="padding-top: 5%;  text-align: center;">
                    ...
                    <a class="text-light mt-4 fw-bold" href="index.php">Home / <a class="text-light"
                            href="blog.php">Blog
